...
Ok, we collect those articles after run the crawler, good, that's a great begin! We can make it better by processing those raw html files, again in your command line, typing  
