...
The goal is to precisely capture every distinct material entity and its associated properties, separating cases where the processing history truly differs, but keeping differences in testing conditions grouped within the same record when the material itself remains the same."""
