...
def split_material_descriptions(material_descriptions: list[MaterialDescriptionBase]):
    """split material descriptions into two group: needed further categorization and no categorization"""
    no_categorization = []
    need_categorization = []
    for description in material_descriptions:
        if description.referred:
            no_categorization.append(description)
            continue
        
    
def dump_material_descriptions_():
    pass
