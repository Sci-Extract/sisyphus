...
QUERY_STRENGTH = "The stress-strain curve of alloy, describes yield strength (ys), tensile strength (uts) and elogation properties, for example, CoCuFeMnNi shows tensile strength of 1300 MPa and total elongation of 20%"
